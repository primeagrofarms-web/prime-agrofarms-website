...
const sidebarItems = [
  ...
  { icon: Users, label: "Leadership", href: "/admin/leadership", active: true },
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white border-b border-border sticky top-0 z-30">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-foreground">Leadership Management</h1>
            </div>
          </div>
        </header>
        ...
        <main className="flex-1 p-6 bg-secondary">
          <div className="text-center py-12 bg-white rounded-xl border border-border">
            ...
            <p className="text-muted-foreground">Leadership management feature coming soon</p>
          </div>
        </main>
      </div>
    </div>
