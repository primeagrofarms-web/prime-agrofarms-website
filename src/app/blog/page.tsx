...
const blogPosts = [
  {
    id: 1,
    title: "The Future of Dairy Farming in Uganda",
    slug: "future-dairy-farming-uganda",
    excerpt: "Exploring how modern technology and sustainable practices are transforming the dairy industry in East Africa.",
    image: "https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=800",
    author: "Prime Agro Farm Team",
    date: "2024-12-10",
    readTime: "8 min read",
  ...
  {
    id: 2,
    title: "Best Practices for Silage Production",
    slug: "silage-production-best-practices",
    excerpt: "A comprehensive guide to producing high-quality silage for year-round livestock nutrition.",
  ...
  {
    id: 3,
    title: "Understanding Cattle Nutrition and Health",
    slug: "cattle-nutrition-health",
    excerpt: "Essential knowledge for maintaining healthy, productive dairy cattle through proper nutrition management.",
  ...
  {
    id: 4,
    title: "Starting a Successful Dairy Farm: A Beginner's Guide",
    slug: "starting-dairy-farm-guide",
    excerpt: "Step-by-step guidance for aspiring dairy farmers looking to establish their own operations.",
            ...
            >
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  <span className="text-sm font-medium text-primary-green mb-2">
            ...
            {blogPosts.slice(1).map((post, index) => (
              ...
              >
                <div className="relative aspect-[16/10]">
                  ...
                  />
                  <div className="absolute top-4 left-4">
                    <span className="px-3 py-1 bg-white/90 text-primary-green text-xs font-medium rounded-full">
                      {post.category}
                    </span>
                  </div>
                </div>
